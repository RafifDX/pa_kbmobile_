...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-%la_a@!mg(5uwt5#to)=xzazb!-gm=a5g-aant!rld1!hy@&0h')
...
# CORS Settings
CORS_ALLOW_ALL_ORIGINS = True  # Development only - ganti di production
